...
# Résumé du projet:
Ce projet est un widget de calendrier pour PC, il permet de voir les taches/evenement des 7 prochains jours a partir d'un fichier de calendrier google de type .ical/.ics, un peu comme la fenetre calendrier que l'on pourrait voir sur un écran de cellulaire.
<br><br>
...
Le calendrier se met automatiquement à jour grace au lien url du calendrier si l'ordinateur à accès à internet.
